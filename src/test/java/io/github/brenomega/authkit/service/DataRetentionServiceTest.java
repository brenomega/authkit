...
class DataRetentionServiceTest {
    ...
    void purgeExpiredSecurityEvents_isIdempotentAcrossRepeatedRuns() {
        ...
        var oauthAuthorizationTransactionRepository = mock(
                OAuthAuthorizationTransactionRepository.class);
        var oauthRefreshTokenFamilyRepository = mock(
                OAuthRefreshTokenFamilyRepository.class);
        ...
        assertEquals(4.0, meterRegistry.counter(
            "security.retention.deleted",
            "dataset",
            "oauth_authorization_codes").count());
    }
}
