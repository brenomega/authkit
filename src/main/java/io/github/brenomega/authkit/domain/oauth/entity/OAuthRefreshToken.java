...
public class OAuthRefreshToken {
    ...
    @Column(name = "replaced_token_hash", length = 64)
    private String replacedTokenHash;

    protected OAuthRefreshToken() {}

    public OAuthRefreshToken(
            String tokenHash, UUID familyId, Instant now, Instant expiresAt) {
    ...
    public void consume(Instant now, String replacement) {
        consumedAt = now;
        replacedTokenHash = replacement;
    }
